                            ...
                            <form action="/update-order-item/{{ $x->order_detail_id }}" method="POST" enctype="multipart/form-data">
                                ...
                                @if($x->product_id)
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <button type="button" data-bs-toggle="modal" data-bs-target="#editOrderItemPopup-{{$x->order_detail_id}}" class="btn button-color rounded-2 btn-sm me-3 btn-edit" title="Edit Produk">
                                            ...
                                            <div class="modal fade" id="editOrderItemPopup-{{$x->order_detail_id}}" tabindex="-1" role="dialog" data-backdrop="static" data-keyboard="false" aria-labelledby="editOrderItemTitle" aria-hidden="true">
